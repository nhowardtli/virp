...
Usage:
    python3 virp_verify.py claim.json --corpus corpus.json --key /root/virp/keys/onode.key
    python3 virp_verify.py claim.json --corpus corpus.json --key /root/virp/keys/onode.key --freshness 600
