...
typedef struct {
     ...
     * over all closers WITH their bodies. (The second quadratic term,
     * the double-spend count over all intent bodies, is gone entirely:
     * intent_approval_citation answers it with an indexed lookup.) Measured on .211 (349,697 entries, 21,793
