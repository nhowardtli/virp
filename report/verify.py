...
# 3. Gate rejections register only sha256(reason text) with no body at all —
#    the reason string goes to the daemon journal, never to the chain.
#    (virp_onode.c, "gatereject-%.16s".)
...
RETENTION_NO_BODY = (
    "no artifact body is stored for this entry type; the chain retains only "
