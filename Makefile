...
.PHONY: test-seat-session-namespace
test-seat-session-namespace:
	@echo "=== seat chain_append is bound to its own session namespace ==="
	python3 tests/test_seat_session_namespace.py
